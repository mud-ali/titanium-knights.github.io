...
function Bigsection(props) {
    ...
    const imgStyle = {
        width: props.image?.size??""
    }

    return (
        <div className="bigsection" >
            <div className="bigsection-container">
                {props.image !== undefined ? <img className="bigsection-image" style={imgStyle} src={props.image.src} alt={props.image.alt} /> : null}
            </div>
            <div className='bigsection-opposite-container'>
